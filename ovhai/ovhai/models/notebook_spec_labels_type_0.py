...
T = TypeVar("T", bound="NotebookSpecLabelsType0")


@_attrs_define
class NotebookSpecLabelsType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        notebook_spec_labels_type_0 = cls()
        ...
        notebook_spec_labels_type_0.additional_properties = additional_properties
        return notebook_spec_labels_type_0
