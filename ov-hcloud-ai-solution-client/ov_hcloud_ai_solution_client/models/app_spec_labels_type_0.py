...
T = TypeVar("T", bound="AppSpecLabelsType0")


@_attrs_define
class AppSpecLabelsType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        app_spec_labels_type_0.additional_properties = additional_properties
        return app_spec_labels_type_0
